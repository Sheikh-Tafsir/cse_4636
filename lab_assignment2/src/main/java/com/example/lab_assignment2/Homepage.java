        ...
        //session is ongoing
            ...
            if (tommoreadd != null) {
                ...
                if (mapCookie != null) {
                    ...
                    //out.println("bruhhh" + mapString +"</br>");
                    ...
                    for(int i=0;i<mapElements.length;i+=1){
                        //out.println("bruhhh1 " + mapElements[i] +"</br>");
                        String[] keyValue=mapElements[i].split("=");
                        //out.println("bruhhh2 " + keyValue[0] +" "+ keyValue[1] +"</br>");
                    ...
                    if(flt==0){
                        ...
                        //out.println("bruh" + cartListString +"</br>");
